...
// Para ejecutarlo con CommonJS hay que descomentar la linea 179
// y comentar la linea 180.
...
var NodeStyle = _interopRequireWildcard(require("./style-business"));
...
var Accounts = _interopRequireWildcard(require("./data-business"));

var ClientAccountsBusines = _interopRequireWildcard(require("./account-business"));
...
function getClientElement(client) {
  ...
  var ul = ClientAccountsBusines.getClientAccountsElement(clientAccounts);
  node.appendChild(ul);
  return node;
}
...
var getClient = require("./data-business");

var clientElement = require("./client-business");

function printClientsAccounts() {
  var clients = getClient.getClients();
  var ul = document.createElement("ul");
...
var printClientAccount = _interopRequireWildcard(require("./client-list-business"));
