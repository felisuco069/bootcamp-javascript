...
document.getElementById("nightPark").addEventListener("change", roomPrice);
document.getElementById("night").addEventListener("change", roomPrice);
document.getElementById("spa").addEventListener("change", roomPrice);
document.getElementById("ocupation").addEventListener("change", roomPrice);
document.getElementById("typeRoom").addEventListener("change", roomPrice);